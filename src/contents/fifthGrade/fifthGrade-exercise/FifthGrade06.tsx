...
import {  comfirmBtn2, dailyBackgroud2, inputSize1, marginTop18, quiz1, quizAll, quizBox2, quizCard1, quizCard2, quizCard3, quizNumber, quizSub2, quizTitle2, rowCenter, sectionSize } from './EmoStyle.ts';
...
const FifthGrade06: React.FC = () => {
  return (
    <div css={dailyBackgroud2}>
        ...
        <div css={quizSub2}>빈칸에 알맞은 수를 써넣어 차례로 계산하세요.</div>
        <div css={quizBox2}>
          <div css={sectionSize}>
            <div css={quizAll}>
              <div css={quiz1}>
